...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?php echo base_url ('index.php/matakuliah')?>" class="nav-link">Mata Kuliah</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?php echo base_url ('index.php/prodi')?>" class="nav-link">Program Studi</a>
      </li>
      <?php
        }
      ?>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?php echo base_url ('index.php')?>" class="nav-link">Profile</a>
      </li>
    </ul>
