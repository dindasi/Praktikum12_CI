      ...
      <div class="card">
        ...
        <?php echo form_open('prodi/save', '', $hidden)?>
            ...
            <div class="form-group row">
                ...
                <div class="col-8">
                <input id="kode" name="kode" value="<?=$prodiedit->kode?>" type="text" aria-describedby="kodeHelpBlock" required="required" class="form-control"> 
            ...
            <div class="form-group row">
                ...
                <div class="col-8">
                <input id="nama" name="nama" value="<?=$prodiedit->nama?>" type="text" class="form-control" aria-describedby="prodiHelpBlock" required="required"> 
            ...
            <div class="form-group row">
                ...
                <div class="col-8">
                <input id="kaprodi" name="kaprodi" value="<?=$prodiedit->kaprodi?>" type="text" class="form-control" required="required">
                </div>
            </div> 
            <div class="form-group row">
